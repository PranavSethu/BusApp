...
export default function BusSearch() {
    ...
    const fetchTrips = async () => {
        try {
            const response = await axios.get("https://busapp-fgg9.onrender.com/api/v1/users/trips/getAll",{ withCredentials: true });
    ...
    const fetchUserTickets = async () => {
        try {
            const response = await axios.get("https://busapp-fgg9.onrender.com/api/v1/users/tickets",{ withCredentials: true });
    ...
    const handleCancelTicket = async (ticketId) => {
        try {
            const response = await axios.put(`https://busapp-fgg9.onrender.com/api/v1/users/tickets/${ticketId}/cancel`,{ withCredentials: true });
    ...
    const handleLogout = async () => {
        try {
            await axios.get("https://busapp-fgg9.onrender.com/api/v1/users/logout", { withCredentials: true });
            navigate('/');
        } catch (error) {
